...
import { ProjectsSection, type Theme } from "@/components/abraj/AbrajSite";
...
export const Route = createFileRoute("/projects/")({
  head: () => ({
    meta: [
      { title: "مشاريعنا — أبراج الماس | Our Projects — ABRAJ ALMAS" },
      { name: "description", content: "تصفح أبرز مشاريع أبراج الماس المنجزة في مجال الشبكات وأنظمة المراقبة والبنية التحتية التقنية." },
    ],
  }),
      ...
      >
        <div className="flex items-end justify-around w-full px-1 pt-2 pb-1">
          {([
            ...
            { id: "partners", icon: Building2,     label: isAr ? "الشركاء"  : "Partners", href: "/partners",  cta: false },
